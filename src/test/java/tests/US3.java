...
public class US3 {
    ...
    public void TC2() throws InterruptedException {
        ...
        WebElement checkbox1 = driver.findElement(By.xpath("//*[@id=\"fileList\"]/tr[1]/td[1]/label"));
        WebElement checkbox2 = driver.findElement(By.xpath("//*[@id=\"fileList\"]/tr[2]/td[1]/label"));
        BrowserUtils.wait(1);

        if (checkbox1.isSelected()) {
            System.out.println("Checkbox#1 is selected. PASSED!");
        } else {
            System.out.println("Checkbox#1 NOT selected. FAILED!");
        }
    ...
    public void TC4() {
        ...
        WebElement newFile = driver.findElement(By.xpath("/html/body/div[3]/div[2]/div[4]/table/tbody/tr/td[1]/a/span[1]"));
        BrowserUtils.wait(1);
        Assert.assertFalse(newFile.isDisplayed(), "FAIL file still here!");
    ...
    public void TC8() {
       ...
       // WebElement newFileCreated = Driver.get().findElement(By.xpath("//*[@id=\"fileList\"]/tr[4]/td[2]/a/span[1]"));
        ...
        try {
            ...
            if (newFileCreated.isDisplayed()) {
                System.out.println("aFile deleted, test PASS");
            }
        }catch (NoSuchElementException e){
            System.out.println("aFile exist, FAIL");
        }
